...
Write-Output "Please enter following information to configure TestTemplate8 application for local use."
...
ConnectionStrings__TestTemplate8DbConnection=Data Source=testtemplate8.sql;Initial Catalog=TestTemplate8Db
ConnectionStrings__TestTemplate8Db_Migrations_Connection=Data Source=host.docker.internal,1433;Initial Catalog=TestTemplate8Db;Encrypt=False
...
# Database username
$db_user_default = "TestTemplate8Db_Login"
