...
using TestTemplate8.Common.MessageBroker.Middlewares.ErrorLogging;
using TestTemplate8.Common.MessageBroker.Middlewares.Tracing;
using TestTemplate8.Core;
using TestTemplate8.Core.Events;
using TestTemplate8.Data;
using TestTemplate8.WorkerServices.FaultService;
using TestTemplate8.WorkerServices.FooService;
...
namespace TestTemplate8.WorkerServices
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                Log.Information("Starting up TestTemplate8 Worker Services.");
            ...
            {
                Log.Fatal(ex, "TestTemplate8 Worker Services failed at startup.");
            }
            finally
            {
                Log.CloseAndFlush();
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    {
                        var connString = new SqlConnectionStringBuilder(configuration.GetConnectionString("TestTemplate8DbConnection"))
                        {
