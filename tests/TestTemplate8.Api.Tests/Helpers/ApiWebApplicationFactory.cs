        ...
        IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureTestServices(services =>
            {
                ...
                services.Remove(services.SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<TestTemplate8DbContext>)));
                ...
                var ctx = scopedServices.GetRequiredService<TestTemplate8DbContext>();
        ...
        public TestTemplate8DbContext CreateDbContext(ITestOutputHelper testOutput = null)
        {
        ...
        {
            private readonly DbContextOptions<TestTemplate8DbContext> _options;
            ...
            {
                _options = new DbContextOptionsBuilder<TestTemplate8DbContext>()
            ...
            public TestTemplate8DbContext BuildContext() =>
                new(_options);
        }
    }
}
